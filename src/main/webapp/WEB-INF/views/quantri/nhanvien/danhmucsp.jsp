		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<!-- /.col -->
					<div class="col-md-12">
						<form:form action="nhanvien/danhmucsp?themDM"
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="form-group row d-flex justify-content-end">
										...
										<a href="nhanvien/danhmucsp" id="cancel-save-modal"
							...
							<div class="card-body">
								<div class="tab-content">
									<div class="active tab-pane" id="activity">
										...
										<form:form
											action="nhanvien/danhmucsp/${thongTinDM.getMaDM() }?suaThongtin"
											...
											<div class="row">
												...
												<div class="col-12">
													<div class=" d-flex justify-content-end">
														...
														<a href="nhanvien/danhmucsp" id="cancel-update-modal"
															class="mx-2 btn btn-secondary">Hủy</a>
													</div>
												</div>
	...
	<div class="modal-dialog modal-lg modal-dialog-scrollable">
		<div class="modal-content">
			<div class="modal-header">
				...
				<!-- <a href="nhanvien/danhmucsp" class="close">&times;</a> -->
			</div>
			<div class="modal-body">
				<div class="row">
					<!-- /.col -->
...
<div class="modal fade " id="exampleModalDisable" tabindex="-1"
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<form:form action="nhanvien/danhmucsp?xoadm" method="post" >

										...
										<tr>
											...
											<td>
												<div class="d-flex justify-content-between px-4">
													<a class=""
														href="quanly/nhacungcap/${ncc.getMaNCC()}?thongtin"><i
														class="fas fa-info-circle"></i> </a> <a class=""
														href="quanly/nhacungcap/${ncc.getMaNCC() }?suaThongtin"><i
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<!-- /.col -->
					<div class="col-md-12">
						<form:form action="quanly/nhacungcap?themNCC"
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="form-group row d-flex justify-content-end">
										...
										<a href="quanly/nhacungcap" id="cancel-save-modal"
							...
							<div class="card-body">
								<div class="tab-content">
									<div class="active tab-pane" id="activity">
										...
										<form:form
											action="quanly/nhacungcap/${thongTinNCC.getMaNCC() }?suaThongtin"
											...
											<div class="row">
												...
												<div class="col-12">
													<div class=" d-flex justify-content-end">
														...
														<a href="quanly/nhacungcap" id="cancel-update-modal"
															class="mx-2 btn btn-secondary">Hủy</a>
													</div>
												</div>
		...
		<div class="modal-content">
			<div class="modal-header">
              ...
              <span aria-hidden="true">&times;</span>
				...
				<!-- <a href="quanly/nhacungcap" class="close">&times;</a> -->
			</div>
			<div class="modal-body">
				<div class="row">
					<!-- /.col -->
...
<div class="modal fade " id="xoanhacungcap" aria-hidden="true">
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<form action="quanly/nhacungcap?xoancc"  method="post">

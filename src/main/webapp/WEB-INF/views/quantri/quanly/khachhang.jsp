											...
											<td>
												<div class="d-flex justify-content-between px-4">
													<a class="" href="quanly/khachhang/${kh.getMaKH()}?thongtin"><i
														...
														href="quanly/khachhang/${kh.getMaKH() }?suaThongtin"><i
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<!-- /.col -->
					<div class="col-md-12">
						<form:form action="quanly/khachhang?themKH" class="form-horizontal" method="post"
							modelAttribute="khachHangMoi" enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<form:input path="taiKhoan.email" class="form-control" id="" />
									...
									<div class="form-group row">
										<label for="" class="col-sm-2 col-form-label text-primary">Mật
											khẩu</label>
										<div class="col-sm-10">
											<form:input path="taiKhoan.matKhau" value="123456" class="form-control"
												id="inputName" />
									...
									<div class="form-group row d-flex justify-content-end">
										...
										<a href="quanly/nhakhien" id="cancel-save-modal"
							...
							<div class="card-body">
								<div class="tab-content">
									<div class="active tab-pane" id="activity">
										...
										<form:form action="quanly/khachhang/${thongTinKH.getMaKH() }?suaKH"
														...
														<div>
															...
															<div class="form-check">
																...
																<form:radiobutton path="taiKhoan.trangThai"
																	value="0" class="form-check-input" label="Khóa"

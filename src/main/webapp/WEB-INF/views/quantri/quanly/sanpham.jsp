											...
											<td>
												<div class="d-flex justify-content-between px-2">
													<a class="" href="quanly/sanpham/${sp.getMaSP()}?thongtin"><i
														...
														href="quanly/sanpham/${sp.getMaSP()}?thongtinchitiet">
						...
						<tbody>
							<c:forEach var="ctsp" items="${danhSachChiTietSanPham }">
								<tr>
									...
									<td class="text-center"><a
										href="resources/file/${ctsp.getSanPham().getHinhAnh() }"
										data-toggle="lightbox"><img
											src="resources/file/${ctsp.getSanPham().getHinhAnh() }"
											alt="Product Image" class="img-size-50" /></a></td>
...
<div class="modal fade " id="exampleModalDisable1" tabindex="-1"
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<form:form action="quanly/sanpham?xoactsp" method="post">
				<div class="modal-footer d-flex justify-content-between">
		...
		<div class="modal-content">
			...
			<div class="modal-body text-primary">
				<div>
					...
					<p>
						Hình ảnh &nbsp;&nbsp;<img
							src="resources/file/${thongTinSP.getHinhAnh() }" width="250px">
					</p>

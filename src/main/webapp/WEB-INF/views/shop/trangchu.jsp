...
<main>
					...
					<div class="carousel-inner">
						<div class="carousel-item position-relative active"
							...
							<img class="position-absolute w-100 h-100"
								src="https://img.dtcn.com/image/themanual/best-sneakers.jpg"
						...
						<div class="carousel-item position-relative"
							style="height: 430px;">
							<img class="position-absolute w-100 h-100"
								src="https://c1.wallpaperflare.com/preview/878/712/970/active-enjoying-happy-legs.jpg"
								style="object-fit: cover;">
							<div
								class="carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
						...
						<div class="carousel-item position-relative"
							style="height: 430px;">
							<img class="position-absolute w-100 h-100"
								src="https://balovnxk.vn/wp-content/uploads/2021/06/ERK01131.jpg"
								style="object-fit: cover;">
							<div
								class=" carousel-caption d-flex flex-column align-items-center justify-content-center">
								<div class="p-3" style="max-width: 700px;">
		...
		<div class="row px-xl-5">
			<div class="col-md-6">
				<div class="product-offer mb-30" style="height: 300px;">
					<img class="img-fluid"
						src="http://file.hstatic.net/1000282067/file/air-jordan-1-high-555088-035-1_b7cbf1b959a04b12b19ba24804ec6815_2048x2048.jpg"
						alt="">
			...
			<div class="col-md-6">
				<div class="product-offer mb-30" style="height: 300px;">
					<img class="img-fluid"
						src="https://giaygiare.vn/upload/images/top-10-mau-giay-sneaker-duoc-yeu-thich-nhat-nam-2020-8.jpg"
						alt="">
					<div class="offer-text">
	...
	<div class="container-fluid pt-5">
		<div class="row px-xl-5 pb-3">
			<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
				<div class="d-flex align-items-center bg-dark mb-4"
					style="padding: 30px; border-radius: 10px;">
					<h1 class="fa fa-check text-primary m-0 mr-3"></h1>
					<h5 class="font-weight-semi-bold m-0 text-white">Sản phẩm chất
						lượng</h5>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
				<div class="d-flex align-items-center bg-dark mb-4"
					...
					<h5 class="font-weight-semi-bold m-0 text-white">Vận chuyển
						nhanh chóng</h5>
				</div>
			</div>
			<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
	...
	<div class="container-fluid pt-5">
		...
		<div>
			<div class="row px-xl-5 pb-3">
				<c:forEach var="danhmuc" items="${danhSachDanh4MucSanPham }">
					<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
						<a class="text-decoration-none"
							href="danhmuc/${danhmuc.getMaDM() }?ds">
							<div class="cat-item d-flex align-items-center mb-4">
								...
								<div class="flex-fill pl-3">
									<h6>${danhmuc.getTenDM() }</h6>
									<a href="danhmuc/${danhmuc.getMaDM() }?ds"><small
										class="text-body bg-primary p-2">100+ Sản phẩm <i
		...
		<div class="container-fluid bg-primary p-5">
			<h3 class="text-dark text-center">ĐĂNG KÝ NGAY ĐỂ NHẬN THÔNG BÁO
				MỚI NHẤT</h3>
			<form action="url" class="d-flex justify-content-center">
				<input class="border-0 col-md-6 p-2 text-dark" type="text"
					name="number" value="email@gmail.com"> <input
					class="bg-dark border-0 px-3 text-white" type="submit"
					value="ĐĂNG KÝ">
			</form>
		</div>
		...
		<div class="container-fluid pt-5 pb-3">
			<h2
				class="section-title position-relative text-uppercase mx-xl-5 mb-4">
				<span class="bg-secondary pr-3">Đề xuất</span>
			</h2>

			<div>
				<div class="row px-xl-5">
					<c:forEach var="sp" items="${danhSach8SanPham }">
						<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
							<div class="product-item bg-light mb-4">
								...
								<div class="text-center py-4">
									<a class="h6 text-decoration-none text-truncate" href="sanpham/${sp.getMaSP() }">${sp.getTenSP() }</a>
									<div
				...
				<div class="col">
					<div class="owl-carousel vendor-carousel">
						<div class="bg-light p-4">
							<img
								src="https://play-lh.googleusercontent.com/eLqKK4MkDoXXbD_F3A_2rs-othxTESxbocvyOGyhAmbNCydgnYKczItIY2-HLYJmhr6Q"
								alt="">
						</div>
						<div class="bg-light p-4">
							<img
						...
						<div class="bg-light p-4">
							<img src="https://cdn-icons-png.flaticon.com/512/731/731962.png"
								alt="">
						</div>
						<div class="bg-light p-4">
							<img
								src="https://www.daihoabinhduong.com/gallery_gen/81715b136d71136f634849c37205a00b_250x250.png"
								alt="">
						</div>
						<div class="bg-light p-4">
							<img
								src="https://cdn.freebiesupply.com/logos/large/2x/new-balance-2-logo-png-transparent.png"
								alt="">
						</div>
						<div class="bg-light p-4">
							<img
								src="https://i.pinimg.com/originals/81/6a/dc/816adc875959202114a14701cd78b434.jpg"
								alt="">
						</div>
						<div class="bg-light p-4">
							<img
								src="https://images-na.ssl-images-amazon.com/images/S/abs-image-upload-na/0/AmazonStores/A1F83G8C2ARO7P/ad2d117171af36589e9fba34c36367ed.w400.h400.jpg"
								alt="">
						</div>
					</div>
				</div>

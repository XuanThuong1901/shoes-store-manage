...
<!-- JavaScript Libraries -->
    ...
    <script src="<c:url value='resources/user/lib/owlcarousel/owl.carousel.min.js'/>"></script>

    <!-- Contact Javascript File -->
    <script src="<c:url value='resources/user/mail/jqBootstrapValidation.min.js'/>"></script>

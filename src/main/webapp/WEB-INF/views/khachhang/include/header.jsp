        ...
        <div class="row bg-secondary py-1 px-xl-5">
            <div class="col-lg-6 d-none d-lg-block leader">
                <div class="d-inline-flex align-items-center h-100 topbar-font">
                    ...
                    <a class="text-body mr-3" href="">Câu hỏi thường gặp<span class="fa fa-question-circle ml-1"></span></a>
                </div>
            </div>
        ...
        <div class="row align-items-center bg-light py-3 px-xl-5 d-none d-lg-flex">
            <div class="col-lg-3">
                <a href="" class="text-decoration-none">
                    ...
                    <span class="h2 text-uppercase text-dark px-2 ml-n1" style="font-weight: 800;">shoeniverse</span>
                </a>
            </div>
            ...
            <div class="col-lg-3 offset-lg-1 col-6 d-flex text-right text-white bg-danger py-2 rounded-service">
                <div><span class="fa fa-phone bg-primary rounded-phone"></span></div>
                <div class="pl-4 ml-5">
            ...
            <div class="col-lg-2 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light"
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="" class="nav-item nav-link">Sandal</a>
                        <a href="" class="nav-item nav-link">Dép</a> 
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <span class="h1 text-uppercase text-light px-2 ml-n1">shoeniverse</span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">MUA SẮM<i
                                        class="fa fa-angle-down ml-1 mt-1"></i></a>
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="cart.html" class="dropdown-item">NAM</a>
                                    <a href="checkout.html" class="dropdown-item">NỮ</a>
                                </div>
                            </div>
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="user.html" class="btn px-0">
